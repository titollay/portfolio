...
const Ticker = ({ topWords, botWords }) => {
  ...
  return (
    <>
      <div className="hidden md:block absolute left-0 right-0 overflow-hidden pointer-events-none z-[5] whitespace-nowrap top-[46%]">
      ...
      <div className="hidden md:block absolute left-0 right-0 overflow-hidden pointer-events-none z-[5] whitespace-nowrap top-[56%]">
